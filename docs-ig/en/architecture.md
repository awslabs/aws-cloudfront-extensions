Amazon CloudFront Extensions contains 3 components: Lambda@Edge & CloudFront Functions collection, CloudFront Security Automations with Amazon WAF and Amazon Shield, monitoring solution.
