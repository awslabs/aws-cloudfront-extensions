...
| [Limit Request Rate](https://github.com/awslabs/aws-cloudfront-extensions/tree/main/function/js/limit-request-rate) | [![Deploy](../images/deploy_button.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=limit-request-rate&templateURL=https:%2F%2Faws-cloudfront-extensions-cff.s3.amazonaws.com%2Flimit-request-rate.yaml)  |
