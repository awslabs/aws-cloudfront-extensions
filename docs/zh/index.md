...
Amazon CloudFront Extensions解决方案包含三个模块：Lambda@Edge和CloudFront Functions合集、基于Amazon WAF与Amazon Shield的CloudFront安全自动化，和监控API，从而帮助客户更方便地使用CloudFront的拓展功能。
