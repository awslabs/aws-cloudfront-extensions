...
const regionData = ssm.getParameter({
        Name: 'userpoolId'
    }).promise();
...
exports.handler = (event, context, callback) => {
    console.log('Start run handle@@@@@@@@@@@@@@@@@@');   

    // var params = {
    //   Name: 'userpoolId' /* required */
    // };
    // var userpoolId = '';
    ...
    //     } else {
    //         userpoolId = data;           // successful response
    //         console.log(data);
    //         console.log(userpoolId);
    //         // console.log('Start run handle@@@@@@@@@@@@@@@@@@' + JWKS);
