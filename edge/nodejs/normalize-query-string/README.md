...
- normalize-query-string - Code for the application's Lambda function, which forward requets to specific content that's under certain folder. 
- events - Invocation events that you can use to invoke the function.
- normalize-query-string/tests - Unit tests for the application code. 
...
```bash
normalize-query-string$ sam build
```

The SAM CLI installs dependencies defined in `normalize-query-string/package.json`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
```bash
aws cloudformation delete-stack --stack-name normalize-query-string
```
