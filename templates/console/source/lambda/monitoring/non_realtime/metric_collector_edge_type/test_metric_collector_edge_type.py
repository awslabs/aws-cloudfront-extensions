...
def test_lambda_handler(monkeypatch):
    ...
    import metric_collector_edge_type
    from metric_collector_edge_type import lambda_handler
    monkeypatch.setattr(metric_collector_edge_type, "collect_metric_data", mock_collect_metric_data, raising=True)
