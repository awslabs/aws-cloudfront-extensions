...
def test_lambda_handler(monkeypatch):
    ...
    import metric_collector_chr_request
    from metric_collector_chr_request import lambda_handler
    monkeypatch.setattr(metric_collector_chr_request, "gen_detailed_by_interval", mock_gen_detailed_by_interval, raising=True)
    monkeypatch.setattr(metric_collector_chr_request, "get_athena_query_result", mock_get_athena_query_result)
