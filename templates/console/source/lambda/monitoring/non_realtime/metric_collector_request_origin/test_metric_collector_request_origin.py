...
def test_lambda_handler(monkeypatch):
    ...
    import metric_collector_request_origin
    from metric_collector_request_origin import lambda_handler
    monkeypatch.setattr(metric_collector_request_origin, "gen_detailed_by_interval", mock_gen_detailed_by_interval, raising=True)
    monkeypatch.setattr(metric_collector_request_origin, "get_athena_query_result", mock_get_athena_query_result)
