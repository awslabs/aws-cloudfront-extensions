...
def test_lambda_handler(monkeypatch):
    ...
    monkeypatch.setattr(metric_collector_status_code_cdn, "gen_detailed_by_interval", mock_gen_detailed_by_interval, raising=True)
    monkeypatch.setattr(metric_collector_status_code_cdn, "get_athena_query_result", mock_get_athena_query_result)
