...
def test_lambda_handler(monkeypatch):
    ...
    import metric_collector_chr_bandwidth
    from metric_collector_chr_bandwidth import lambda_handler
    monkeypatch.setattr(metric_collector_chr_bandwidth, "gen_detailed_by_interval", mock_gen_detailed_by_interval, raising=True)
    monkeypatch.setattr(metric_collector_chr_bandwidth, "get_athena_query_result", mock_get_athena_query_result)
