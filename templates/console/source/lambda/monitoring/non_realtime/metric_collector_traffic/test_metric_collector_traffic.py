...
def test_lambda_handler(monkeypatch):
    ...
    import metric_collector_traffic
    from metric_collector_traffic import lambda_handler
    monkeypatch.setattr(metric_collector_traffic, "gen_detailed_by_interval", mock_gen_detailed_by_interval, raising=True)
    monkeypatch.setattr(metric_collector_traffic, "get_athena_query_result", mock_get_athena_query_result)
