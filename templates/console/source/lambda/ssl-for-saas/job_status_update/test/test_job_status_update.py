...
@mock_dynamodb
@mock_acm
def test_lambda_handler_with_failed_certification(monkeypatch):
    monkeypatch.setenv("LAMBDA_TASK_ROOT", "Lambda root", prepend=False)
    ...
    ddb_table.put_item(Item={
        ...
        'cert_total_number': 1,
        'certValidationStageStatus': 'FAIL',
        'dcv_validation_msg': 'CNAME value need to add into DNS hostzone to finish DCV',
        'job_input': '{\"cert_total_number\": 1, \"auto_creation\": \"true\",\"certValidationStageStatus\": \"INPROGRESS\",\"dcv_validation_msg\":\"CNAME value need to add into DNS hostzone to finish DCV\"}'
    })
