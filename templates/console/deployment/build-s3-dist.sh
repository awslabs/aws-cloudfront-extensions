...
## Get reference for all important folders
##-----------------------------------------------------------------------------------
#staging_dist_dir="$__dir/staging"
#template_dist_dir="$__dir/global-s3-assets"
#build_dist_dir="$__dir/regional-s3-assets"
#source_dir="$__dir/../source"
#
#cd $__dir
#
##------------------------------------------------------------------------------
...
#
#    # run helper
#    do_cmd $__dir/helper.py ${staging_dist_dir}
#
...
#
## we have helper.py
#do_cmd cd $__dir/cdk-solution-helper
#do_cmd npm install
#
#
#
...
# [[ $run_helper == "true" ]] && {
#     echo "node $__dir/cdk-solution-helper/index"
#     node $__dir/cdk-solution-helper/index
#     if [ "$?" = "1" ]; then
